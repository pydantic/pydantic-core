...
def test_nullable_via_union():
    ...
    assert exc_info.value.errors() == [
        {'kind': 'none_required', 'loc': ['none'], 'message': 'Value should be None/null', 'input_value': 'hello'},
        {
            'kind': 'int_parsing',
            'loc': ['int'],
...
def test_strict_union():
    ...
    assert exc_info.value.errors() == [
        {'kind': 'bool_type', 'loc': ['bool'], 'message': 'Value should be a valid boolean', 'input_value': '123'},
        {'kind': 'int_type', 'loc': ['int'], 'message': 'Value should be a valid integer', 'input_value': '123'},
    ]
