...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((1,), Err('Value should be a valid datetime [kind=datetime_type')),
        (time(1, 2, 3), Err('Value should be a valid datetime [kind=datetime_type')),
...
@pytest.mark.parametrize(
    ...
    [
        (datetime(2022, 6, 8, 12, 13, 14), datetime(2022, 6, 8, 12, 13, 14)),
        (date(2022, 6, 8), Err('Value should be a valid datetime [kind=datetime_type')),
        ('2022-06-08T12:13:14', Err('Value should be a valid datetime [kind=datetime_type')),
        (b'2022-06-08T12:13:14', Err('Value should be a valid datetime [kind=datetime_type')),
        (time(1, 2, 3), Err('Value should be a valid datetime [kind=datetime_type')),
        (1654646400, Err('Value should be a valid datetime [kind=datetime_type')),
        (Decimal('1654646400'), Err('Value should be a valid datetime [kind=datetime_type')),
    ],
)
...
def test_keep_tz_bound():
    ...
    with pytest.raises(ValidationError, match=r'Value should be greater than 2022-01-01T00:00:00 \[kind=greater_than'):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            Err('Value should be a valid datetime, timezone offset must be less than 24 hours [kind=datetime_parsing,'),
        ),
        (True, Err('Value should be a valid datetime [kind=datetime_type')),
        (None, Err('Value should be a valid datetime [kind=datetime_type')),
        ([1, 2, 3], Err('Value should be a valid datetime [kind=datetime_type')),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ('2022-06-08T12:13:14', datetime(2022, 6, 8, 12, 13, 14)),
        ('2022-06-08T12:13:14Z', datetime(2022, 6, 8, 12, 13, 14, tzinfo=timezone.utc)),
        (123, Err('Value should be a valid datetime [kind=datetime_type')),
        (123.4, Err('Value should be a valid datetime [kind=datetime_type')),
        (True, Err('Value should be a valid datetime [kind=datetime_type')),
    ],
)
...
def test_tz_comparison():
    ...
    # but not gt
    with pytest.raises(ValidationError, match=r'Value should be greater than 2022-01-01T15:00:00Z \[kind=greater_than'):
