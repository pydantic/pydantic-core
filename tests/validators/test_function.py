...
def test_function_before():
    ...
    v = SchemaValidator(schema=core_schema.with_info_before_validator_function(f, core_schema.str_schema()))
...
def test_function_before_no_info():
    ...
    v = SchemaValidator(schema=core_schema.no_info_before_validator_function(f, core_schema.str_schema()))
...
def test_val_info_repr(config, kwargs, expected_repr):
    ...
    v = SchemaValidator(
        schema=core_schema.with_info_before_validator_function(f, core_schema.str_schema()), config=config
    )
...
def test_function_wrap():
    ...
    v = SchemaValidator(schema=core_schema.with_info_wrap_validator_function(f, core_schema.str_schema()))
...
def test_function_wrap_no_info():
    ...
    v = SchemaValidator(schema=core_schema.no_info_wrap_validator_function(f, core_schema.str_schema()))
...
def test_wrap_error():
    ...
    v = SchemaValidator(schema=core_schema.with_info_wrap_validator_function(f, core_schema.int_schema()))
...
def test_function_wrap_error_hide_input(config, input_str):
    ...
    v = SchemaValidator(
        schema=core_schema.with_info_wrap_validator_function(f, core_schema.int_schema()), config=config
    )
...
def test_function_after():
    ...
    v = SchemaValidator(schema=core_schema.with_info_after_validator_function(f, core_schema.str_schema()))
...
def test_function_no_info():
    ...
    v = SchemaValidator(schema=core_schema.no_info_after_validator_function(f, core_schema.str_schema()))
...
def test_function_after_error_hide_input(config, input_str):
    ...
    v = SchemaValidator(
        schema=core_schema.with_info_after_validator_function(f, core_schema.str_schema()), config=config
    )
...
def test_function_validation_info_mode():
    ...
    v = SchemaValidator(schema=core_schema.with_info_after_validator_function(f, core_schema.int_schema()))
    assert v.validate_python(1) == 1
    assert calls == ['python']
    calls.clear()
    assert v.validate_json('1') == 1
    ...
    v = SchemaValidator(schema=core_schema.with_info_wrap_validator_function(f_w, core_schema.int_schema()))
    assert v.validate_python(1) == 1
    assert calls == ['python']
    calls.clear()
    assert v.validate_json('1') == 1
