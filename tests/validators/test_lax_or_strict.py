...
def test_lax_or_strict():
    v = SchemaValidator(schema=core_schema.lax_or_strict_schema(core_schema.str_schema(), core_schema.int_schema()))
...
def test_lax_or_strict_default_strict():
    v = SchemaValidator(
        schema=core_schema.lax_or_strict_schema(core_schema.str_schema(), core_schema.int_schema(), strict=True)
    )
