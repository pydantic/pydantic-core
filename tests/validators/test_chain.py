            ...
            'steps': [
                {
                    'type': 'function',
                    'mode': 'plain',
                    'function': {'type': 'function', 'call': lambda v, info: f'{v}-1'},
                },
                {
                    'type': 'function',
                    'mode': 'plain',
                    'function': {'type': 'function', 'call': lambda v, info: f'{v}-2'},
                },
                {
                    'type': 'function',
                    'mode': 'plain',
                    'function': {'type': 'function', 'call': lambda v, info: f'{v}-3'},
                },
                {
                    'type': 'function',
                    'mode': 'plain',
                    'function': {'type': 'function', 'call': lambda v, info: f'{v}-4'},
                },
            ],
        }
    )
    ...
    v = SchemaValidator(
        {
            ...
            'schema': {
                ...
                'steps': [
                    ...
                    {'type': 'function', 'mode': 'plain', 'function': {'type': 'function', 'call': f}},
                ],
            },
        }
    )
