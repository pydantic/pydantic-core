...
def test_alias(py_or_json: PyOrJson):
...
def test_alias_allow_pop(py_or_json: PyOrJson):
    v = py_or_json(
        {
            'type': 'typed-dict',
            'return_fields_set': True,
...
def test_alias_path(py_or_json: PyOrJson, input_value, expected):
...
def test_aliases_path_multiple(py_or_json: PyOrJson, input_value, expected):
    v = py_or_json(
        {
            'type': 'typed-dict',
            'return_fields_set': True,
...
def test_paths_allow_by_name(py_or_json: PyOrJson, input_value):
    v = py_or_json(
        {
            'type': 'typed-dict',
...
def test_alias_extra(py_or_json: PyOrJson):
    v = py_or_json(
        {
            'type': 'typed-dict',
            'typed_dict_extra_behavior': 'allow',
...
def test_alias_extra_by_name(py_or_json: PyOrJson):
    v = py_or_json(
        {
            'type': 'typed-dict',
            'typed_dict_extra_behavior': 'allow',
...
def test_alias_extra_forbid(py_or_json: PyOrJson):
    v = py_or_json(
        {
            'type': 'typed-dict',
