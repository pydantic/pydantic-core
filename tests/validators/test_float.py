    ...
    [
        ...
        (
            ...
            Err(
                ...
                '[kind=value_greater_than_equal, context={ge: 0}, input_value=-0.1, input_type=float]'
            ),
        ),
        ({'gt': 0}, 0.1, 0.1),
        (
            ...
            0,
            Err(
                'Value must be greater than 0 [kind=value_greater_than, context={gt: 0}, input_value=0, input_type=int]'
            ),
        ),
        ({'le': 0}, 0, 0),
        ({'le': 0}, -1, -1),
