...
def test_function(value, expected_python, expected_json):
    s = SchemaSerializer(
        core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(repr_function))
    )
...
def test_function_args():
    ...
    s = SchemaSerializer(core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(double)))
...
def test_function_error():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(raise_error))
    )
...
def test_function_known_type():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_plain_function_ser_schema(append_42, json_return_type='list')
        )
    )
...
def test_function_args_str():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_plain_function_ser_schema(append_args, json_return_type='str')
        )
    )
...
def test_invalid_return_type():
    with pytest.raises(SchemaError, match='function-plain -> json_return_type\n  Input should be'):
        SchemaSerializer(
            core_schema.any_schema(
                serialization=core_schema.general_plain_function_ser_schema(lambda _: 1, json_return_type='different')
            )
        )
...
def test_dict_keys():
    ...
    s = SchemaSerializer(
        core_schema.dict_schema(
            core_schema.int_schema(serialization=core_schema.general_plain_function_ser_schema(fmt))
        )
    )
...
def test_function_only_json():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(double, when_used='json'))
    )
...
def test_function_unless_none():
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_plain_function_ser_schema(repr_function, when_used='unless-none')
        )
    )
    assert s.to_python(4) == '4'
...
def test_wrong_return_type():
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_plain_function_ser_schema(repr_function, json_return_type='int')
        )
    )
...
def test_function_wrap():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(serialization=core_schema.general_wrap_function_ser_schema(f, core_schema.int_schema()))
    )
...
def test_deque():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_wrap_function_ser_schema(serialize_deque, core_schema.any_schema())
        )
    )
...
def test_custom_mapping():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_wrap_function_ser_schema(
