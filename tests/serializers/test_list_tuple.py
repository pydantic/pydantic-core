    ...
    s = SchemaSerializer(
        {
            ...
            'items_schema': [
                core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(partial(f, 'a'))),
                core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(partial(f, 'b'))),
            ],
            'extra_schema': core_schema.any_schema(
                serialization=core_schema.general_plain_function_ser_schema(partial(f, 'extra'))
            ),
        }
    )
