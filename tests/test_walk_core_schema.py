...
def test_walk_core_schema_before():
    ...
    assert handler.called == [
        ...
        'union -> model',
        'union -> model -> model-fields',
        'union -> model -> model-fields -> model-field',
        'union -> model -> model-fields -> model-field -> int',
        'union -> model -> model-fields -> int',
        'union -> model -> model-fields -> int -> int',
        'union -> model -> model-fields -> int',
        'union -> dataclass',
