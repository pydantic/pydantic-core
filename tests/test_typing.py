...
def test_ser_function_plain():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(serialization=core_schema.general_plain_function_ser_schema(f, json_return_type='str'))
    )
...
def test_ser_function_wrap():
    ...
    s = SchemaSerializer(
        core_schema.any_schema(
            serialization=core_schema.general_wrap_function_ser_schema(f, core_schema.str_schema(), when_used='json')
        )
    )
