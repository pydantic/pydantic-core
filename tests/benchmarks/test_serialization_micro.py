...
def test_direct_list_str(benchmark):
    serializer = SchemaSerializer({'type': 'list', 'items_schema': {'type': 'str-direct'}})
...
@pytest.mark.benchmark(group='list-of-str')
def test_common_list_str(benchmark):
...
def test_direct_list_int(benchmark):
    serializer = SchemaSerializer({'type': 'list', 'items_schema': {'type': 'int-direct'}})
...
@pytest.mark.benchmark(group='list-of-int')
def test_common_list_int(benchmark):
