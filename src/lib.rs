...
pub use serializers::{to_json, PydanticSerializationError, PydanticSerializationUnexpectedValue, SchemaSerializer, PythonReferenceHolder};
...
fn _pydantic_core(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_class::<PythonReferenceHolder>()?;
