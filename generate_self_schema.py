...
ENUM_PLACEHOLDER: Any = '<enum placeholder>'
...
def get_schema(obj) -> core_schema.CoreSchema:  # noqa: C901
    if isinstance(obj, str):
        ...
        return {'type': 'is-instance', 'cls': ENUM_PLACEHOLDER}
    ...
    elif issubclass(origin, Type) and get_args(obj) == (Enum,):
        return {'type': 'is-subclass', 'cls': ENUM_PLACEHOLDER}
    ...
    for field_name, field_type in typed_dict.__annotations__.items():
        ...
        if type(field_type) == ForwardRef:
            ...
            if 'CoreSchema' == fr_arg or re.search('[^a-zA-Z]CoreSchema', fr_arg):
                ...
                elif fr_arg == 'Dict[LiteralValue, CoreSchema]':
...
def main() -> None:
    ...
    python_code = (
        '# this file is auto-generated by generate_self_schema.py,'
        f' DO NOT edit manually\nimport enum\n\nself_schema = {schema}\n'
    )
    python_code = python_code.replace(f"'{ENUM_PLACEHOLDER}'", 'enum.Enum')
    try:
