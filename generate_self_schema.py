...
core_types_spec = importlib.util.spec_from_file_location('_typing', str(THIS_DIR / 'pydantic_core' / 'core_schema.py'))
...
def main():
    ...
    assert get_origin(schema_union) is Union, 'expected pydantic_core.core_schema.Schema to be a union'
