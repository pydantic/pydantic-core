...
class ArgumentsV2Parameter(TypedDict, total=False):
    name: Required[str]
    schema: Required[CoreSchema]
    mode: Literal[
        'positional_only',
...
def arguments_v2_parameter(
    ...
    *,
    ...
    param = core_schema.arguments_v2_parameter(
        name='a', schema=core_schema.str_schema(), mode='positional_only'
    )
    schema = core_schema.arguments_v2_schema([param])
    v = SchemaValidator(schema)
...
class ArgumentsV2Schema(TypedDict, total=False):
    type: Required[Literal['arguments-v2']]
    arguments_schema: Required[list[ArgumentsV2Parameter]]
    populate_by_name: bool
    var_args_schema: CoreSchema
    var_kwargs_mode: VarKwargsMode
    var_kwargs_schema: CoreSchema
...
def arguments_v2_schema(
    arguments: list[ArgumentsV2Parameter],
    *,
    populate_by_name: bool | None = None,
    ref: str | None = None,
    metadata: dict[str, Any] | None = None,
    ...
    param_a = core_schema.arguments_v2_parameter(
        name='a', schema=core_schema.str_schema(), mode='positional_only'
    )
    param_b = core_schema.arguments_v2_parameter(
        name='kwargs', schema=core_schema.bool_schema(), mode='var_kwargs_uniform'
    )
    schema = core_schema.arguments_v2_schema([param_a, param_b])
    v = SchemaValidator(schema)
